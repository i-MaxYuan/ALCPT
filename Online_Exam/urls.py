...
urlpatterns = [
    ...
    re_path(r'^exam/', include([
        ...
        re_path(r'^testpaper/', include([
            ...
            re_path(r'^(?P<testpaper_id>[0-9]+)/unvalid$', exam.testpaper_unvalid, name='testpaper_unvalid'),
    ...
    re_path(r'^testee/', include([
        re_path(r'^exam/', include([
            ...
            re_path(r'^start_exam/(?P<exam_id>[0-9]+)$', testee.start_exam, name='testee_start_exam'),
            re_path(r'^start_practice/(?P<exam_id>[0-9]+)$', testee.start_practice, name='testee_start_practice'),
