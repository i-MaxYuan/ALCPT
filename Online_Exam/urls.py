...
urlpatterns = [
    ...
    re_path(
        ...
        include([
            re_path(r'^(?P<question_id>[0-9]+)$',
                    testee.ReportQuestionView.as_view(),
    ...
    re_path(
        ...
        #             name='proclamation_create'),
            re_path(r'^create$',
                    proclamation.ProclamationCreateView.as_view(),
                    name='proclamation_create'),
            ...
            re_path(r'^notification_center$',
                    proclamation.NotificationCenterView.as_view(),
    ...
    re_path(
        ...
        include([
            ...
            re_path(r'^(?P<exam_id>[0-9]+)/edit$',
                    exam.ExamEditView.as_view(),
                    name='exam_edit'),
            re_path(r'^(?P<exam_id>[0-9]+)/delete$',
                    exam.ExamDeleteView.as_view(),
                    name='exam_delete'),
            re_path(
                r'^testpaper/',
                include([
                    re_path(r'^list$',
                            exam.TestpaperListView.as_view(),
                            name='testpaper_list'),
                    re_path(r'^create$',
                            exam.TestpaperCreateView.as_view(),
                            name='testpaper_create'),
                    re_path(r'^(?P<testpaper_id>[0-9]+)/content$',
                            exam.TestpaperContentView.as_view(),
                    ...
                    re_path(r'^(?P<testpaper_id>[0-9]+)/edit$',
                            exam.TestpaperEditView.as_view(),
                            name='testpaper_edit'),
    ...
    re_path(
        ...
        include([
            re_path(
                ...
                include([
                    ...
                    re_path(r'^favorite_question_list$',
                            testee.FavoriteQuestionListView.as_view(),
            ...
            re_path(r'^achievement_list$',
                    testee.AchievementListView.as_view(),
            ...
            re_path(
                ...
                include([
                    re_path(r'^(?P<kind>(listening|reading))$',
                            testee.PracticeCreateView.as_view(),
