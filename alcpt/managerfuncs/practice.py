...
from alcpt.models import User, AnswerSheet
...
def create_practice(*, user: User, practice_type: ExamType, question_types: list, num_questions: int):
    ...
    practice = AnswerSheet.objects.create(name=name,
