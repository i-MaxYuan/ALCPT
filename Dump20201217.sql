...
--
-- Table structure for table `alcpt_achievement`
--

DROP TABLE IF EXISTS `alcpt_achievement`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `alcpt_achievement` (
  ...
  PRIMARY KEY (`id`),
  CONSTRAINT `alcpt_achievement_category_2815ad42_check` CHECK ((`category` >= 0))
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `alcpt_achievement`
--

LOCK TABLES `alcpt_achievement` WRITE;
/*!40000 ALTER TABLE `alcpt_achievement` DISABLE KEYS */;
INSERT INTO `alcpt_achievement` VALUES (1,'閱讀新手','做閱讀練習十次','聽說你剛使用本系統....先做閱讀練習十次試試手感吧!\r\n',4,100,1,10,'default_trophy/default_trophy.png'),(2,'閱讀練習初心者','閱讀練習15次','聽說你已經練習10次了...那再五次也ok吧...？',4,150,1,15,'default_trophy/default_trophy.png'),(3,'剛入學','參加一次模擬考','還沒跟大家考過試啊？趁有模擬考的時候加把勁吧！',1,200,1,1,'default_trophy/default_trophy.png'),(4,'模擬考厭世ing','模擬考3次','看來你也被荼毒了不少呢',1,1000,1,3,'default_trophy/default_trophy.png'),(5,'閱讀練習達人','閱讀練習20次','閱讀練習王',4,200,1,20,'default_trophy/default_trophy.png'),(6,'兩腳書櫥','閱讀練習50次','完成閱讀練習五十次',4,1000,1,50,'default_trophy/default_trophy.png'),(7,'模擬考佛化','參加五次模擬考','參加五次模擬考的你也是挺可憐的',1,700,1,5,'default_trophy/default_trophy.png'),(12,'閱讀練習小嫩嫩','閱讀練習1次','閱讀練習1次',4,50,1,1,'photos/default_trophy.png');
/*!40000 ALTER TABLE `alcpt_achievement` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `alcpt_answer` VALUES (1778,1,67,41),(1779,1,67,36),(1780,1,67,537),(1781,1,67,29),(1782,1,67,5),(1783,1,67,32),(1784,1,67,35),(1785,1,67,37),(1786,1,67,34),(1787,1,67,43);
...
INSERT INTO `alcpt_answersheet` VALUES (67,'2020-12-17 09:54:38.383857',1,20,61,5,1);
...
INSERT INTO `alcpt_exam` VALUES (61,'閱讀練習-2020/12/17 09:54:37',4,0,0,20,NULL,'2020-12-17 09:54:37.512449',0,NULL,0,5,53);
...
INSERT INTO `alcpt_group` VALUES (1,'資管系','2020-02-11 13:39:37.002878','2020-02-11 13:39:37.001069',1),(2,'109年班','2020-02-24 23:11:28.996531','2020-02-24 23:11:28.984803',1),(3,'資管系109年班','2020-03-19 01:00:30.974127','2020-03-19 01:00:30.972082',1),(4,'資管系110年班','2020-12-15 16:31:13.446662','2020-03-19 00:59:41.768574',1);
...
INSERT INTO `alcpt_group_member` VALUES (108,4,5),(109,4,8),(110,4,9);
...
CREATE TABLE `alcpt_proclamation` (
  ...
  CONSTRAINT `alcpt_proclamation_chk_1` CHECK ((`exam_id` >= 0)),
  CONSTRAINT `alcpt_proclamation_chk_2` CHECK ((`report_id` >= 0))
...
INSERT INTO `alcpt_testpaper` VALUES (53,'閱讀練習-2020/12/17 09:54:37','2020-12-17 09:54:37.498049',0,'2020-12-17 09:54:37.499236',0,5,0);
...
INSERT INTO `alcpt_testpaper_question_list` VALUES (1344,53,5),(1349,53,29),(1350,53,32),(1348,53,34),(1351,53,35),(1345,53,36),(1353,53,37),(1347,53,41),(1346,53,43),(1352,53,537);
...
CREATE TABLE `alcpt_user` (
  ...
  CONSTRAINT `alcpt_user_chk_1` CHECK ((`level` >= 0))
...
INSERT INTO `alcpt_user` VALUES (1,'pbkdf2_sha256$180000$oTBTGig3RK5k$FhXD0UVPuiTiM+u6BsWeJA4pis6KlnTCIPlN6Z4b/2Q=','Maxium1997','蘇典煒',1,2,59,'wei860925@gmail.com',1,'2020-04-27 10:21:05.554946','2019-10-15 12:44:32.551000','2020-04-27 10:21:05.545087','1090630218\r\nNational Defense University\r\nInformation Management','photos/default_propic.png',0,1),(2,'pbkdf2_sha256$216000$oUq9HWveAtiA$QyQxpMdkk8eTqeMDfQZ/vuduQcoYrZQK/1saI93SuFs=','qaz74159','黃柏豪',1,2,63,'qaz74159@yahoo.com.tw',0,'2020-11-30 11:35:54.616266','2020-02-11 13:02:52.789648','2020-11-30 11:35:54.563597',NULL,'photos/default_propic.png',0,1),(4,'pbkdf2_sha256$180000$pSz5ws6jqokY$ElB2cOb0dAXOVhZS7qBWBwk5Iv4uAgL0zDBcK2xkQvE=','mcndu0001','袁葆宏',1,3,2,'max_yuan_i@gmail.com',0,'2020-04-16 09:19:50.836809','2020-02-11 14:47:59.132463','2020-04-16 09:19:50.834488',NULL,'photos/default_propic.png',0,1),(5,'pbkdf2_sha256$216000$iXDJtOXY1TDu$vuITuhj1A2HI/j4e2qEN6COMxG2uBUboi0x8U+rXDG8=','joy9517538246','劉昀昕',2,2,63,'joy9517538246@gmail.com',0,'2020-12-17 09:54:44.131941','2020-02-12 13:07:00.411616','2020-12-11 10:47:53.507039',' MCNDU','photos/joy9517538246_劉昀昕_KyygCQP.jpg',12650,10),(6,'pbkdf2_sha256$180000$qZyeHIu6TwYz$VR6qvUuvuHudtKxKDpWOrR+jkI0CRNDOAmTX+AiH914=','TonyChen9305','陳信綸',1,2,4,'gmvup4xjp6@gmail.com',0,'2020-04-16 09:48:03.188463','2020-02-12 13:12:58.230412','2020-04-15 22:15:15.481541',NULL,'photos/default_propic.png',0,1),(7,'pbkdf2_sha256$180000$mGWgaVkhdl5T$w2Ae2vzEAXxUSJUm0ZqlI6+x+sP8/WPRrUvZhg0F/HQ=','smile100226','傅晴俞',2,2,8,'smile100226@gmail.com',0,'2020-04-16 09:50:50.195881','2020-02-12 13:16:21.354390','2020-04-16 09:50:50.193535',NULL,'photos/default_propic.png',0,1),(8,'pbkdf2_sha256$180000$1lFO00qItmwO$RKtFjJaOH4wd03XER5Kqs5e8cCGC0aktwcaRf8CFFeM=','mayou66321','賴昱婷',2,2,63,'mayou66321@gmail.com',0,'2020-04-16 09:54:43.196971','2020-02-14 13:24:38.246472','2020-04-16 09:54:43.195055',NULL,'photos/default_propic.png',0,1),(9,'pbkdf2_sha256$216000$IPkSMXW9r56V$uZzG/JMPXhVuC6R4dFGdIimrK8tQcqS+14ApeS/VkMQ=','1100630204','黃子祐',1,2,63,'huangzihyou@gmail.com',0,'2020-11-30 14:19:05.921545','2020-02-14 13:25:18.142812','2020-11-30 14:19:05.870970',NULL,'photos/default_propic.png',0,1),(10,'pbkdf2_sha256$180000$UxGqLrZnZSDU$5N60fls8VBBuQcJW2vh3Te8LaMGk9Dzrux7m8mm2VUY=','terry90209','楊家齊',1,2,16,'terry90209@gmail.com',0,'2020-04-16 09:50:20.857451','2020-03-18 15:31:27.930608','2020-04-16 09:50:20.854515','','photos/default_propic.png',0,1);
/*!40000 ALTER TABLE `alcpt_user` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `alcpt_userachievement`
--

DROP TABLE IF EXISTS `alcpt_userachievement`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `alcpt_userachievement` (
  `id` int NOT NULL AUTO_INCREMENT,
  ...
  `user_id` int NOT NULL,
  PRIMARY KEY (`id`),
  KEY `alcpt_userachievemen_achievement_id_5cf009f6_fk_alcpt_ach` (`achievement_id`),
  KEY `alcpt_userachievement_user_id_951479b3_fk_alcpt_user_id` (`user_id`),
  CONSTRAINT `alcpt_userachievemen_achievement_id_5cf009f6_fk_alcpt_ach` FOREIGN KEY (`achievement_id`) REFERENCES `alcpt_achievement` (`id`),
  CONSTRAINT `alcpt_userachievement_user_id_951479b3_fk_alcpt_user_id` FOREIGN KEY (`user_id`) REFERENCES `alcpt_user` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=76 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `alcpt_userachievement`
--

LOCK TABLES `alcpt_userachievement` WRITE;
/*!40000 ALTER TABLE `alcpt_userachievement` DISABLE KEYS */;
/*!40000 ALTER TABLE `alcpt_userachievement` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `captcha_captchastore` VALUES (417,'MZVM','mzvm','bcd8131a44e2647933fe4daec8a105ea58bbefb2','2020-12-11 10:51:38.330213');
...
INSERT INTO `django_content_type` VALUES (1,'admin','logentry'),(27,'alcpt','achievement'),(7,'alcpt','answer'),(8,'alcpt','answersheet'),(9,'alcpt','choice'),(10,'alcpt','department'),(11,'alcpt','exam'),(12,'alcpt','group'),(24,'alcpt','notification'),(13,'alcpt','optionlist'),(14,'alcpt','proclamation'),(15,'alcpt','question'),(23,'alcpt','reply'),(16,'alcpt','report'),(17,'alcpt','reportcategory'),(18,'alcpt','squadron'),(19,'alcpt','student'),(22,'alcpt','testeelist'),(20,'alcpt','testpaper'),(6,'alcpt','user'),(28,'alcpt','userachievement'),(3,'auth','group'),(2,'auth','permission'),(21,'captcha','captchastore'),(4,'contenttypes','contenttype'),(25,'django_plotly_dash','dashapp'),(26,'django_plotly_dash','statelessapp'),(5,'sessions','session');
...
-- Dump completed on 2020-12-17 10:23:57
